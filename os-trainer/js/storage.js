...
OST.storage = (function () {
  var KEY = 'ost_state_v1';
  ...
  function defaultState() { return { solved: {}, notes: {}, currentLevel: 0 }; }
  ...
  function getNote(levelId) { return load().notes[levelId] || ''; }
  function setNote(levelId, text) { var s = load(); s.notes[levelId] = text; save(s); }
...
OST.levels = OST.levels || [];
OST.registerLevel = function (lvl) { OST.levels.push(lvl); };
